...
use fuchsia_component_registry::InMemoryComponentRegistry;
...
use fuchsia_workflow::{LockedComponent, Node, NodeType, Workflow};
    ...
    (
        ...
        Node {
            ...
            node_type: NodeType::Join {
                strategy: fuchsia_config::JoinStrategy::All,
            },
            inputs: HashMap::new(),
            timeout_ms: None,
            max_retry_attempts: None,
