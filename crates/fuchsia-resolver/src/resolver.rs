...
use fuchsia_component_registry::{ComponentRegistry, InstalledComponent};
use fuchsia_config::{NodeDef, NodeType as ConfigNodeType, WorkflowDef};
use fuchsia_workflow::{LockedComponent, LockedLoop, Node, NodeType, Workflow};
...
mod tests {
  use super::*;
  use fuchsia_component_registry::{ComponentManifest, RegistryError};
  use fuchsia_config::{ComponentRef, Edge, JoinStrategy};
  ...
  impl MockRegistry {
    ...
    fn add_component_with_tasks(
      ...
      use fuchsia_component_registry::TaskExport;
